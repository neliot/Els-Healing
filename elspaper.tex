...
%%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=7.5cm]{figures/SwarmStableShape1}{Stable swarm edges\label{concave:SwarmStableShape1}}
\begin{figure}
\begin{center}
...
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=4cm]{figures/PerimeterBotsCircle4}{void reduction result\label{fig:InnerPerimeter3}}
\begin{figure}
\begin{center}
...
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=4cm]{figures/PerimeterBotsCircle2}{void reduction result (swarm without voids)\label{fig:OuterPerimeter3}}
\begin{figure}
\begin{center}
...
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=8.3cm]{figures/Concave8060End}{void reduction end\label{fig:ConcaveEndPoint}}
\begin{figure}
\begin{center}
...
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=8.3cm]{figures/ConcavePerimeter4560-DIST}{void reduction stability effect distance\label{voids:ConcavePerimeter4560-DIST}}
\begin{figure}
\begin{center}
...
%SWARMHOLE-DIST-4560.py
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=8.3cm]{figures/ConcavePerimeter4560-DIST-2}{void reduction stability effect distance\label{voids:ConcavePerimeter4560-DIST-2}}
\begin{figure}
\begin{center}
...
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=8.3cm]{figures/ConcavePerimeter4560-MAG}{void reduction stability effect magnitude\label{voids:ConcavePerimeter4560-MAG}}
\begin{figure}
\begin{center}
...
%SWARMHOLE-MAG-4560.py
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=8.3cm]{figures/ConcavePerimeter4560-MAG-2}{void reduction stability effect magnitude\label{voids:ConcavePerimeter4560-MAG-2}}
\begin{figure}
\begin{center}
...
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=8.3cm]{figures/ConcavePerimeter4560-1}{void reduction perimeter effect\label{methods:ConcavePerimeter4560-1}}
\begin{figure}
\begin{center}
...
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=8.3cm]{figures/OilSlick}{void reduction oil slick surrounding\label{voids:OilSlick}}
\begin{figure}
\begin{center}
...
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=8.3cm]{figures/OilSpillSimulator}{Oil spill containment simulation\label{concave:OilSpillSimulation}}
\begin{figure}
\begin{center}
...
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=8.3cm]{figures/SWARMCOVER456060BASELINE}{Swarm without void reduction (60 Obstacle)\label{voids:ObstacleTest2}}
\begin{figure}
\begin{center}
...
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=8.3cm]{figures/SWARMCOVER456060CONCAVE}{Swarm with void reduction (60 Obstacle)\label{voids:ObstacleTest3}}
\begin{figure}
\begin{center}
...
%\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=6cm]{figures/IdealSwarm}{Swarm structure with no void reduction\label{voids:IdealSwarm}}
\begin{figure}
\begin{center}
